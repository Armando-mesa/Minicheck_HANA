...
( SELECT
  ...
  ( SELECT
    ...
    ( SELECT                    /* Modification section */
        'C-D20' BEGIN_TIME,                  /* YYYY/MM/DD HH24:MI:SS timestamp, C, C-S<seconds>, C-M<minutes>, C-H<hours>, C-D<days>, C-W<weeks>, E-S<seconds>, E-M<minutes>, E-H<hours>, E-D<days>, E-W<weeks>, MIN */
  ...
  ( SELECT
    ...
    FROM
    ( SELECT
        CASE WHEN STRTDATE = '00000000' THEN CURRENT_TIMESTAMP ELSE TO_TIMESTAMP(STRTDATE || STRTTIME, 'YYYYMMDDHH24MISS') END BEGIN_TIME,
      ...
      ( SELECT
          ...
          CASE WHEN TB.STRTTIME IN ('00000000', '') THEN TB.SDLTIME ELSE TB.STRTTIME END STRTTIME,
        ...
        ( SELECT
          ...
          TST01 TS ON
            TB.JOBLOG = TS.DNAME
        WHERE
          STRTDATE != '00000000' and SDLDATE != '00000000'
      )
    )
  ) J
  WHERE
