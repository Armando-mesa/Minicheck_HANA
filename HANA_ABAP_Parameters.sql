...
- In some cases the parameter history may not reflect the current parameter state, so checking via report RSPARAM on ABAP side is useful to confirm
...
- PARAMETER_NAME
  ...
  '%'                --> No restriction related to parameter name
