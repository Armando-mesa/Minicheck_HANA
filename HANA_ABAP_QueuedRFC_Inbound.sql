...
( SELECT
  ...
  ( SELECT
    ...
    ( SELECT                  /* Modification section */
        ...
        '%' QRFCUSER,
        '%' ERRMESS,
        'QRFCFNAM, QRFCUSER, ERRMESS' AGGREGATE_BY,           /* TIME, MAND, DEST, QNAME, QSTATE, QRFCUSER, QRFCFNAM, ERRMESS or comma separated combinations, NONE for no aggregation */
