...
- 2023/07/11:  1.2 (DURATION_S included)
- 2024/06/01:  1.3 (ROOT_NAME included)
...
- ROOT_NAME
  ...
  'SPTA_RFC_INVOKE_INTERNAL' --> Application root SPTA_RFC_INVOKE_INTERNAL
...
- ROOT_NAME:    Application root name
...
( SELECT
    ...
    CASE WHEN BI.AGGREGATE_BY = 'NONE' OR INSTR(BI.AGGREGATE_BY, 'ROOT')       != 0 THEN S.ROOT_NAME            ELSE MAP(BI.ROOT_NAME,    '%', 'any', BI.ROOT_NAME)         END ROOT_NAME,
  ...
  ( SELECT
    ...
    ( SELECT                          /* Modification section */
        ...
        '%' REQUEST_TYPE,
        '%' BATCH_JOB,
        'NONE' AGGREGATE_BY,         /* TIME, SERVER, MANDT, WP_ID, WP_TYPE, CPID, ACTION, TABLE, WAITING, APP_USER, APP_SOURCE, ROOT, REQUEST, BATCH_JOB or comma separated combinations, NONE for no aggregation */
  ...
  WHERE
    ...
    S.ROOT_NAME LIKE BI.ROOT_NAME AND
  ...
  GROUP BY
    ...
    CASE WHEN BI.AGGREGATE_BY = 'NONE' OR INSTR(BI.AGGREGATE_BY, 'ROOT')       != 0 THEN S.ROOT_NAME            ELSE MAP(BI.ROOT_NAME,    '%', 'any', BI.ROOT_NAME)         END,
