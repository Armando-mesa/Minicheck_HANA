...
- SITE_ID in statistics server histories available with SAP HANA >= 2.00.060
- M_CS_COLUMNS_PERSISTENCE.PERSISTENCE_TYPE = 'PAGED' changed to LOAD_UNIT = 'PAGE' with SAP HANA >= 2.00.080
...
- 2024/07/26:  2.9 (dedicated 2.00.080+ version including adjusted M_CS_COLUMNS_PERSISTENCE behavior)
...
( SELECT
  ...
  SELECT
    3510,
    'Secure Store',
    MAP(COUNT(*), 0, 'SSFS', 'LSS'),
    '3048191'
  FROM
    KEY_MANAGEMENT_CONFIGURATIONS
  UNION ALL
  SELECT
    3600,
