...
( SELECT
  ...
  WHERE
    ...
    ( BI.ONLY_WORKLOAD_SETTINGS = ' ' OR
      P.KEY IN ( 'affinity', 'async_close_use_thread_limit', 'bulk_load_threads', 'busy_executor_threshold', 'capture_thread_count', 'change_compression_threads', 
                 'check_max_concurrency', 'check_max_concurrency_percent', 'default_statement_concurrency_limit', 'default_statement_concurrency_max_limit', 'dynamic_parallel_insert_max_workers', 
                 ...
                 'max_concurrent_queries', 'max_cpuload_for_merge', 'max_cpuload_for_parallel_merge', 'max_gc_parallelity', 'max_number_of_data_jobs', 
                 'max_num_recompile_threads', 'max_sql_executors', 'min_free_sql_workers', 'num_cores', 'num_exec_threads', 'num_merge_threads', 'num_of_async_rep_queue', 
                 'num_parallel_fox', 'other_threads_act_weight', 'other_worker_worker_weight_ratio', 
                 'parallel_data_backup_backint_channels', 'parallel_merge_part_threads', 'parallel_merge_threads', 'parallel_processing_load_limit',
                 'prepare_threads', 'recovery_queue_count', 'request_queue_enable', 'request_queue_load_balancing', 'request_queue_size',
                 'row_order_optimizer_threads', 'split_history_parallel', 'split_threads', 'sql_executors', 
                 'statement_memory_limit', 'statement_memory_limit_rel', 'statement_memory_limit_threshold', 'table_partition_size', 'tables_preloaded_in_parallel', 
                 'threadpool', 'token_per_table', 'total_statement_memory_limit', 'total_statement_memory_limit_rel' ) OR
