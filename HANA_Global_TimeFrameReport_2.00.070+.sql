...
- HANA_Global_TimeFrameReport_2.00.070+
...
- 2022/05/24:  2.4 (dedicated 2.00.060+ version including SITE_ID)
- 2023/10/29:  2.5 (dedicated 2.00.070+ version including APPLICATION_COMPONENT_NAME and APPLICATION_COMPONENT_TYPE)
...
( SELECT
    ...
    T.APPLICATION_COMPONENT_NAME APP_COMP_NAME,
...
UNION ALL SELECT TOP 1 80720, '' FROM THREADS
UNION ALL SELECT TOP 1 80722, LPAD('SAMPLES', 11) || CHAR(32) || LPAD('AVG_ACTIVE_THREADS', 18)|| CHAR(32) || LPAD('PCT_OF_TOTAL_LOAD', 17) || CHAR(32) || 'APPLICATION_COMPONENT_NAME' FROM THREADS
UNION ALL SELECT TOP 1 80724, LPAD('=', 11, '=') || CHAR(32) || LPAD('=', 18, '=') || CHAR(32) || LPAD('=', 17, '=') || CHAR(32) || RPAD('=', 80, '=') FROM THREADS
UNION ALL
SELECT
  80730 + LN / 1000, LPAD(SAMPLES, 11) || CHAR(32) || LPAD(ACT_THR, 18) || CHAR(32) || LPAD(THR_PCT, 17) || CHAR(32) || APP_COMP_NAME
FROM
( SELECT
    ROW_NUMBER () OVER (ORDER BY SUM(T.NUM_SAMPLES) DESC) LN,
    T.APP_COMP_NAME,
...
WHERE
  LN <= TOP_N_THREAD_APP_COMP_NAMES
