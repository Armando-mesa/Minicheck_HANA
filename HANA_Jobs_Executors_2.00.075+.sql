...
- SUSPENDED_WAITING_JOB_WORKER_COUNT available in HOST_JOBEXECUTOR_WORKER_GROUPS 
  with SAP HANA >= 2.00.075 (bug 315443) 
...
- 2024/01/15:  1.7 (dedicated 2.00.075+ version including SUSPENDED_WAITING_JOB_WORKER_COUNT in history)
