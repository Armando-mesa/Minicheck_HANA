...
( SELECT
  ...
  ( SELECT                                                      /* Modification section */
      ...
      '%' SCHEMA_NAME,
      '%' TABLE_LOCATION,
      '568ad61a873cb34443ea7b3e8baf173a' STATEMENT_HASH,
      '%' TABLE_NAME,
      ...
      'NONE' AGGREGATE_BY,       /* TIME, HOST, PORT, HASH, SQL_TYPE, PLAN_ID, STORE, INV_REASON, SHARING_TYPE, DIST, SCHEMA, LOCATION, INTERNAL, TABLES, APP_NAME, APP_SOURCE, PINNED, ENGINES or comma separated list, NONE for no aggregation */
