  ...
  ( SELECT
    ...
    ( SELECT
        ...
        CASE
          ...
          WHEN 'CDS_VIEW'          LIKE BI.STATEMENT_CLASS AND ( S.STATEMENT_STRING LIKE '%/* Entity name:%' OR S.APPLICATION_SOURCE LIKE 'CL_RRP_DB_CDS%' )                             THEN 'CDS_VIEW'
          ...
          WHEN 'LIVECACHE'         LIKE BI.STATEMENT_CLASS AND S.STATEMENT_HASH IN ( '11b1c4b452b55b7fea973c5c3e7547df', '2fe987d90027ee74e82001499bae57bf', 
                                     ...
                                     '5fbd592536c53068deb5b4a67272d7a0', 'f12b30f24a33fde01082983778ef35dd', 'a34890b38a9b16fb44327f36a618efc9', '099952519dab17d505c8e3cb3d245196', 
                                     '8001561cb4947fe18fd7e967e9a1931e', '57dec217b2c81ec47bd0577131c8196b', '03adbc8704374d289ecce4bd8f1a3150', '52273b2666beb1a8ee46f069e7759b3b', 
                                     '439daf39eb6987ab5ef620bd4756ef3b', '20b2fd8aeb4db6a26931cc61f6db4cd3', 'ec765107843434d8097b6c796e493a61', '2efdc94d660cf4b20c235059ab369898', 
                                     '481f650b89dbedae171995ea9a645d97', '565f8588bcbf95fdd964510fd4e8ad27', 'b473d796296125065b1857e239924b11', 'e3868db606001d6780f58b56c85b977a', 
                                     'c004e3e7d510a429896b839c9a0b9e0b', 'bc671ed9c3058b43c12aafbab573e891' )                                                                            THEN 'LIVECACHE'
      ...
      ( SELECT
        ...
        ( SELECT                                                      /* Modification section */
            ...
            '%' SCHEMA_NAME,
            '%' STATEMENT_HASH,
            'CDS_VIEW' STATEMENT_CLASS,            /* ABAP_BUFFER, AGING_COLD, AGING_CURR, AGING_OTHER, CDS_VIEW, COMPAT_VIEW, CONCAT, FDA_READ, FDA_WRITE, INLIST, LIVECACHE, PROC_CALL, PROC_NOT_UNFOLDED, 
      ...
      WHERE
        ...
        CASE
          ...
          WHEN 'AGING_CURR'        LIKE BI.STATEMENT_CLASS AND S.STATEMENT_STRING LIKE '%WITH RANGE_RESTRICTION(_CURRENT_)%'                                                             THEN 'AGING_CURR'
          WHEN 'AGING_OTHER'       LIKE BI.STATEMENT_CLASS AND S.STATEMENT_STRING LIKE '%WITH RANGE_RESTRICTION(%)%'                                                                     THEN 'AGING_OTHER'
          WHEN 'LIVECACHE'         LIKE BI.STATEMENT_CLASS AND S.STATEMENT_HASH IN 
                                   ( '03adbc8704374d289ecce4bd8f1a3150', '0555162ef70915eb8eb672670bd6c6b3', '099952519dab17d505c8e3cb3d245196', '11b1c4b452b55b7fea973c5c3e7547df', 
                                     '11ccb7ff8be1cd39d058c4616ebc1e46', '17bd0e4181db35ada2fdb4c682f6eb0b', '1db5c91fffcadec8f6551bdca82adf44', '20b2fd8aeb4db6a26931cc61f6db4cd3', 
                                     '2b637fd280f55baf313331486ac35723', '2efdc94d660cf4b20c235059ab369898', '2fe987d90027ee74e82001499bae57bf', '31140725b1f4a46369aab247c0b7e097', 
                                     '3371f7da0b57dbf46f4c056921376b2b', '3554924da9a9ef871625c35f7127da58', '439daf39eb6987ab5ef620bd4756ef3b', '481f650b89dbedae171995ea9a645d97', 
                                     '4e100847ee8a76ccfd8630d23dad66ba', '52273b2666beb1a8ee46f069e7759b3b', '540f5a0b90c3dde6badaf758b4f999ca', '565f8588bcbf95fdd964510fd4e8ad27', 
                                     '57461b5a5d2adb64e80ebbeebe3a329d', '57dec217b2c81ec47bd0577131c8196b', '5d110ba33c2e0314ff186019c37be2c7', '5fbd592536c53068deb5b4a67272d7a0', 
                                     '683b80896e3550eea06ade4a3a855917', '75698fbb304e406dca77e4b87fe3946c', '7b54142eca356166c71929d03c462dc6', '8001561cb4947fe18fd7e967e9a1931e',
                                     '80aed209c3c3691b535d4d9a82c5a993', '81788f9c7ecf4c6253e8099f7ca9eea0', '8637ffebfcc65ab0d613d10c42a86f3f', '8a1bcc8b73f1a2a21b194779ed603b80', 
                                     '8cd8929305df59e136926a31cf6ba797', '8fa09e6dfa200434333e3728dfac986e', '9dac2f34cd80ff538bbb4773f8aed514', 'a34890b38a9b16fb44327f36a618efc9', 
                                     'a464569c7abe55d26c35a07034a99a2f', 'ae3891f8898465b9c844d36f806d1c78', 'b10e09354238da886f63b2f2de09f4ee', 'b473d796296125065b1857e239924b11', 
                                     'b52d2cc6afb4f07f8f9c2064e87abd93', 'b59c3c5005309a050d5e035155133b85', 'b735b0cdfe3c8c595aa76166901f68c2', 'bafec15d2b8d4cdb478fb1f50d6d2b16', 
                                     'bc671ed9c3058b43c12aafbab573e891', 'be96367bc1dbd364a00584477fe2261a', 'c004e3e7d510a429896b839c9a0b9e0b', 'c3a6938605f1d3c5a10f58b30be2014d', 
                                     'd909d52390ed83bb90f01dd467a0a2f6', 'e3868db606001d6780f58b56c85b977a', 'ec765107843434d8097b6c796e493a61', 'f12b30f24a33fde01082983778ef35dd', 
                                     'fc00dc4612028ce1ce686bd10ecc1761', '8a1bcc8b73f1a2a21b194779ed603b80', 'b10e09354238da886f63b2f2de09f4ee', 'd909d52390ed83bb90f01dd467a0a2f6', 
                                     '57461b5a5d2adb64e80ebbeebe3a329d', '11ccb7ff8be1cd39d058c4616ebc1e46', 'f97424065815221c9b36d27cb671c329', '40e6646599fe5c5a04f7441ef1e579d0', 
                                     'fb0fef08b6e0f1d46cde07d8835545dd'
                                   )                                                                                                                                                     THEN 'LIVECACHE'
          WHEN 'NATIVE'            LIKE BI.STATEMENT_CLASS AND S.STATEMENT_STRING LIKE '%/* Contains Native SQL */%'                                                                     THEN 'NATIVE'
