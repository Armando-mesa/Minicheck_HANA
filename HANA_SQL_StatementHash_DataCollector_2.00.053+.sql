...
- HANA_SQL_StatementHash_DataCollector_2.00.053+
...
- 2022/06/19:  4.0 (DB_USER filter added)
- 2022/07/21:  4.1 (DATABASE VERSION HISTORY section added)
- 2022/08/14:  4.2 (SCHEMA_NAME filter added)
- 2023/11/26:  4.3 (SQL cache memory information added)
- 2024/07/11:  4.4 (FUNCTIONS added)
...
( SELECT
  ...
  ( SELECT                /* Modification section */
      ...
      'b52416aaca7e508ef66195ba6e531925' STATEMENT_HASH,
      -1 PLAN_ID,
      '%' DB_USER,
      '%' SCHEMA_NAME,
      20 MAX_RESULT_LINES,
...
( SELECT
    ...
    F.IS_VALID,
    MAP(F.IS_DETERMINISTIC, 'TRUE', 'X', ' ') DET,
...
( SELECT
  ...
  ( SELECT
    ...
    WHERE
      ...
      ES.SCHEMA_NAME LIKE BI.SCHEMA_NAME
  )
  WHERE
    MAX_RESULT_LINES = -1 OR LINE_NO <= MAX_RESULT_LINES
),
...
( SELECT
  ...
  WHERE
    ...
    B.WAITING_SCHEMA_NAME LIKE BI.SCHEMA_NAME
),
...
( SELECT   10 LINE_NO, '*******************************************' LINE                                                            FROM DUMMY UNION ALL
  ...
  SELECT TOP 1 3655, RPAD('SCHEMA_NAME', SCHEMA_LEN) || CHAR(32) || RPAD('FUNCTION_NAME', FUNCTION_LEN) || CHAR(32) || RPAD('FUNC_TYPE', 10) || CHAR(32) || 
    RPAD('USAGE_TYPE', 10) || CHAR(32) || RPAD('DET', 3) || CHAR(32) || RPAD('DEPENDENT_OBJECTS', 79) FROM ACCESSED_FUNCTIONS UNION ALL
  SELECT TOP 1 3656, RPAD('=', SCHEMA_LEN, '=') || CHAR(32) || RPAD('=', FUNCTION_LEN, '=') || CHAR(32) || RPAD('=', 10, '=') || CHAR(32) || 
    RPAD('=', 10, '=') || CHAR(32) || RPAD('=', 3, '=') || CHAR(32) || RPAD('=', 79, '=') FROM ACCESSED_FUNCTIONS UNION ALL
  SELECT 3660 + ROW_NUMBER() OVER (ORDER BY F.SCHEMA_NAME, F.FUNCTION_NAME) / 100, RPAD(F.SCHEMA_NAME, SCHEMA_LEN) || CHAR(32) || RPAD(F.FUNCTION_NAME, FUNCTION_LEN) || CHAR(32) || RPAD(F.FUNCTION_TYPE, 10) || CHAR(32) ||
    RPAD(F.USAGE_TYPE, 10) || CHAR(32) || RPAD(F.DET, 3) || CHAR(32) || IFNULL(STRING_AGG(D.BASE_OBJECT_NAME, ', ' ORDER BY D.BASE_OBJECT_NAME), '')
  FROM
