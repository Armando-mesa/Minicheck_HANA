...
- 2022/05/26:  1.9 (dedicated 2.00.060+ version including SITE_ID for data source HISTORY)
- 2023/08/08:  2.0 (SERVICE_NAME removed, ADDR_USED_PCT included)
- 2024/01/31:  2.0 (HEAP_UNUSED_GB and FAST_RESTART_MEMORY_MAPPED_SIZE included)
...
- MIN_SEG_SIZE_MB:  Minimum segment size (MB)
...
( SELECT
  ...
  ( SELECT
      ...
      AVG(TO_DECIMAL(M.VIRTUAL_ADDRESS_SPACE_TOTAL_SIZE)) VIRTUAL_ADDRESS_SPACE_TOTAL_SIZE,
