...
- HANA_Tables_LargestTables_2.00.040+_ABAP
...
- You have to be connected to the SAP<sid> schema otherwise the following error is issued:
  ...
  [259]: invalid table name: Could not find table/view TADIR in schema

- This ABAP specific statement variant includes an additional column COMPONENT with the ABAP component of the table.
...
- 2022/08/25:  2.2 (dedicated ABAP version including application details)
- 2023/04/30:  2.3 (ONLY_TABLES_WITH_NSE_RECOMMENDATION included)
...
( SELECT
  ...
  ( SELECT
    ...
    ( SELECT
        ...
        'BC_SLD_CHANGELOG,BDCP,BDCP2,BDCPS,BGRFC_IUNIT_HIST,BTCEVTHISTORY,BTCJOBEPP,BTCJSTAT,CCMLOG,CCMLOGD,CCMOBJKEYS,CCMOBJLST,CCMSESSION,CCQUEUE,CCQUEUESLICE,CCTABCONTSLDATA,' ||
        'CDHDR,CDPOS,CDPOS_STR,CDPOS_UID,CE_SCENARIOS_,CNS_CP,CNV_PE_TPM_CLU,CNV_PE_TPM_CLU_T,COIX_DATA40,' ||
        'CONSISTENCY_CHECK_HISTORY_,CONSISTENCY_CHECK_HISTORY_ERRORS_,COUNT_CA_DETAIL,COUNT_CA_ERR_MSG,COUNT_CA_HEADER,COUNT_CA_ITEM,COUNT_CA_PRODUCT,' ||
        ...
        'MDMFDBEVENT,MDMFDBID,MDMFDBPR,MERGED_TRACES_FOR_COCKPIT,MONITORINGADDITIONALOPTIONENTRY,MONITORINGENTRY,' ||
        'NRIVSHADOW,OBJECT_HISTORY,ODQDATA,ODQDATA_C,ODQDATA_F,ODTD_ER, ODTD_ER_ATT_BIN,ORA_SNAPSHOT,ORA_SQLC_DATA,ORA_SQLC_HEAD,' ||
        ...
        'SDBAD,SDBAH,SE16N_CD_DATA,SE16N_CD_KEY,SEC_CONTEXT_BLKD,SECM_CACHE,SICFRECORDER,SMD_HASH_TABLE,SMO8FTCFG,' ||
        ...
        'SRT_CDTC,SRT_MMASTER,SRT_MONILOG_DATA,SRTM_DATA,SRTM_SUB,SRTMP_DATA,SRTMP_PROC,SRTMP_PROG,SRTMP_SUB,SRTM_SUB,SRT_MVERSIONS,' ||
        'SRT_RTC_DATA,SRT_RTC_DATA_RT,SRT_RTC_DT_RT,SRT_SEQ_HDR_STAT,' ||
