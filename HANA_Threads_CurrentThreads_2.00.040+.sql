...
- 2023/08/03:  3.2 (ONLY_EXTERNAL_CONNECTIONS included and CONN_ID semantics for -1 changed)
- 2023/11/16:  3.3 (redesign of TABLE_NAME(S) output column including TOP_TABLE_COUNT and MIN_TOP_TABLE_SIZE_MB filters)
- 2024/03/14:  3.4 (inclusion of other characteristics in TABLE_NAMES like backup or procedure calls)
...
( SELECT                                      /* Modification section */
    ...
    'NONE' AGGREGATE_BY,          /* HOST, PORT, SERVICE, CONN_ID, LOG_CONN, PAR_CONN, CLIENT_PID, HASH, DB_USER, APP_NAME, APP_USER, APP_SOURCE, THREAD_TYPE, THREAD_STATE, THREAD_METHOD, THREAD_DETAIL, 
      THREAD_ID, CALLER, CALLING, LOCK_NAME, LOCKS_OWNED, NUMA_NODE, QUEUEING, TRANS_ID, PASSPORT_COMPONENT, PASSPORT_ACTION and comma separated combinations, NONE for no aggregation */
