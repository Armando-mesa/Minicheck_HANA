...
- 2021/09/11:  2.8 (PASSPORT related information included)
      ...
      ( SELECT
        ...
        ( SELECT
          ...
          ( SELECT                                                      /* Modification section */
              ...
              '%Semaphore Wait%' THREAD_STATE,               /* e.g. 'Running', 'Network Read' or 'Semaphore Wait' */
              '%' THREAD_METHOD,
              '%' THREAD_DETAIL,
              '%' STATEMENT_HASH,
              '%' ROOT_STATEMENT_HASH,
              ...
              ' ' EXCLUDE_EMPTY_STATEMENT_EXECUTION_IDS,
              'HISTORY' DATA_SOURCE,
              'HASH' AGGREGATE_BY,     /* SAMPLE_TIME, HOST, PORT, THREAD_ID, THREAD_TYPE, THREAD_METHOD, THREAD_DETAIL, THREAD_STATE, STATE_LOCK, HASH, ROOT, DB_USER, APP_NAME, 
