...
HANA_Threads_ThreadSamples_FilterAndAggregation_2.00.070+
...
- WORKLOAD_CLASS_NAME in thread histories available with SAP HANA >= 2.00.060
...
- 2022/05/27:  3.5 (dedicated 2.00.060+ version including SITE_ID for data source HISTORY)
- 2022/10/23:  3.6 (STATEMENT_MEMORY_LIMIT and WORKLOAD_CLASS_NAME included)
- 2023/08/03:  3.7 (ONLY_EXTERNAL_CONNECTIONS included and CONN_ID semantics for -1 changed)
- 2023/10/29:  3.8 (dedicated 2.00.070+ version including APPLICATION_COMPONENT_NAME and APPLICATION_COMPONENT_TYPE)
- 2023/11/15:  3.9 (redesign of TABLE_NAME(S) output column including TOP_TABLE_COUNT and MIN_TOP_TABLE_SIZE_MB filters)
- 2024/01/27:  4.0 (DURATION sort option included and duration / active output columns renamed / rearranged)
- 2024/03/14:  4.1 (inclusion of other characteristics in TABLE_NAMES like backup or procedure calls)
...
- ACTIVE_MS:           Duration of currently active database request (ms)
...
- DAY:                 Sample day
- HOUR:                Sample hour
- ACTIVE_H:            Duration of currently active database request (h)
- ACTIVE_MIN:          Duration of currently active database request (minutes)
- ACTIVE_S:            Duration of currently active database request (s)

[EXAMPLE OUTPUT]

------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
|NM|STL|SML |ACTIVE_S|CONN_ID|THREAD_ID|TABLE_NAME      |R|THREAD_TYPE    |THREAD_METHOD        |THREAD_STATE    |Q|LOCK_NAME                    |STATEMENT_HASH                  |THREAD_DETAIL                                                                                                                                                                                                                                                  |DB_USER|APP_NAME       |APP_USER    |APP_SOURCE                            |PASSPORT_COMPONENT |PASSPORT_ACTION                 |CALLER|CALLING               |
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
| 1|  0|   0|     208|     -1|   139068|                | |MergedogMerger |merging              |Job Exec Waiting| |JobBarrier Wait for Jobs     |no SQL (merging)                |61 of 63 table(s): SAPC11:_SYS_SPLIT_EDID4~11                                                                                                                                                                                                                  |#      |MergedogMerger |#           |MergedogMerger                        |                   |                                |415443|207480                |
| 2|  0|   0|     208|     -1|   139099|                | |MergedogMerger |merging              |Job Exec Waiting| |JobBarrier Wait for Jobs     |no SQL (merging)                |63 of 63 table(s): SAPC11:_SYS_SPLIT_EDID4~8                                                                                                                                                                                                                   |#      |MergedogMerger |#           |MergedogMerger                        |                   |                                |415443|205137                |
| 1|  0|   0|     384|     -1|   196901|                | |JobWorker      |GCJob                |Running         | |#                            |no SQL (GCJob)                  |GCJob[0x26076d000a1618dc-EID, CleanupFileExecutedByGC, TS= 130561839540, compareTS= 0, TID= 93089815805, transIndex= 2087651, CleanupStrategy_MVCC, pagecnt=1, rawsize=4096]@0x00007f554d3c7400                                                                |#      |JobWorker      |#           |JobWorker                             |                   |                                |30563 |                      |
| 7|  0|   0|     204|     -1|   198441|                | |JobWorker      |prepareDeltaMergeSave|Running         | |#                            |no SQL (prepareDeltaMergeSave)  |IndexName: SAPC11:_SYS_SPLIT_EDID4~14 Attribute: 210/$trexexternalkey$                                                                                                                                                                                         |#      |JobWorker      |#           |JobWorker                             |                   |                                |415436|                      |
| 1|  0|   0|     197|     -1|   205137|                | |JobWorker      |prepareDeltaMergeSave|Running         | |#                            |no SQL (prepareDeltaMergeSave)  |IndexName: SAPC11:_SYS_SPLIT_EDID4~8 Attribute: 210/$trexexternalkey$                                                                                                                                                                                          |#      |JobWorker      |#           |JobWorker                             |                   |                                |139099|                      |
| 4|  0|   0|     204|     -1|   207480|                | |JobWorker      |prepareDeltaMergeSave|Running         | |#                            |no SQL (prepareDeltaMergeSave)  |IndexName: SAPC11:_SYS_SPLIT_EDID4~11 Attribute: 210/$trexexternalkey$                                                                                                                                                                                         |#      |JobWorker      |#           |JobWorker                             |                   |                                |139068|                      |
| 1|  0|   0|     172|     -1|   208837|                | |JobWorker      |JobWorker            |Running         | |#                            |no SQL (JobWorker)              |JobWorker                                                                                                                                                                                                                                                      |#      |JobWorker      |#           |JobWorker                             |                   |                                |      |                      |
| 4|  0|   0|     208|     -1|   415436|                | |MergedogMerger |merging              |Job Exec Waiting| |JobBarrier Wait for Jobs     |no SQL (merging)                |62 of 63 table(s): SAPC11:_SYS_SPLIT_EDID4~14                                                                                                                                                                                                                  |#      |MergedogMerger |#           |MergedogMerger                        |                   |                                |415443|198441                |
| 7|  0|   0|   52238|     -1|   415443|                | |MergedogMonitor|joining              |Semaphore Wait  | |MergedogMerger CompletionWait|no SQL (joining)                |waiting for merge threads to complete                                                                                                                                                                                                                          |#      |MergedogMonitor|#           |MergedogMonitor                       |                   |                                |      |415436, 139099, 139068|
| 1|  0|   0|     248|     -1|   419011|                | |SqlExecutor    |NoAction             |Running         | |#                            |no SQL (NoAction)               |NoAction                                                                                                                                                                                                                                                       |#      |SqlExecutor    |#           |SqlExecutor                           |C11/saphana3_C11_33|FARR_CONTR0700112210232#00006   |      |                      |
| 4| 56| 300|       0| 300048|   139251|/1RA/0SD034CO   | |SqlExecutor    |ExecutePrepared      |Running         | |#                            |9feecb4e4e438fcedc164517a32e3e33|SELECT DISTINCT  "MANDT" , "KEYPP" , "SRCDOC_COMP" , "SRCDOC_LOGSYS" , "SRCDOC_TYPE" , "SRCDOC_ID" , "CONDITION_TYPE" , "TIMESTAMP_UTC" , "PL_ACCOUNT" , "GL_ACCOUNT" , "BETRW" , "WAERS" , "BETRH" , "HWAER" , "BETR2" , "HWAE2" , "BETR3" , "HWAE3" , "PERCEN|SAPC11 |ABAP:C11       |BWP_BW      |CL_FARR_RAI_SELECTION=========CP:10187|C11/saphana3_C11_33|BIREQU_9S1FJ2VXPBUAKXJUXBOCF5F6V|      |                      |
| 1|  0|   0|       0| 307823|   139272|                | |SqlExecutor    |ExecutePrepared      |Running         | |#                            |no SQL (ExecutePrepared)        |SELECT TOP 1 "MANDT" , "NAME" , "TYPE" , "USERNAME" , "HASH" , "OBJECT" , "FORUSER" , "RC" , "REASON" , "REASON2" , "REASON3" , "REASON4" , "REASON5" , "CDS" , "FIELD1" , "FIELD2" , "FIELD3" , "FIELD4" , "FIELD5" , "FIELD6" , "FIELD7" , "FIELD8" , "FIELD9|SAPC11 |ABAP:C11       |HCS_REMOTE  |/1LT/SAPLHCS001000000149717:0         |C12/hanaci_C12_15  |/1LT/IUC_LOAD_MT_049_003        |      |                      |
| 1| 56| 300|       0| 308429|   139241|FARR_ATTAHLORIPR| |SqlExecutor    |ExecutePrepared      |Running         | |#                            |3377dcc12da344f9e1a3fa96c59dc60d|SELECT DISTINCT  "PROP_NAME" , "OBJECT_ID" FROM "FARR_ATTAHLORIPR" WHERE "PROP_NAME" = # AND "IO_CLASS" = # AND "PROP_SECI" = # AND "PROP_VALUE" = #  WITH RANGE_RESTRICTION('CURRENT')                                                                        |SAPC11 |ABAP:C11       |WF_BATCH_BGR|SAPLSDCL:70286                        |C11/saphana1_ISP_33|FARR_CONTR0700112210232#00004   |      |                      |
| 6| 56| 300|       0| 308602|   139267|ZZV_X_SA_SISKODR| |SqlExecutor    |ExecutePrepared      |Running         | |#                            |3c5466cc9d6d6e463e6e763fa8731e8a|SELECT "MANDT" , "GUID" , "COUNTER" , "REF_GUID" , "USID" , "TID" , "MSG_GUID" , "FILENAME" FROM "ZZV_D_SA_SISKODR" WHERE "MANDT" = # AND "GUID" = # LIMIT 1  WITH RANGE_RESTRICTION('CURRENT')                                                                |SAPC11 |ABAP:C11       |ZV_ARIBA_O2C|ZCL_ZV_SA_PROC_PACK_MANAGER===CP:589  |C11/saphana1_C11_33|Z1SA20221023AR_08_00001         |      |                      |
| 1| 36| 200|       0| 308755|   139458|NAST            | |SqlExecutor    |ExecQidItab          |Job Exec Waiting|X|JobBarrier Wait for Jobs     |e1e746510efab6b3c433909529143774|SELECT "MANDT" , "KAPPL" , "OBJKY" , "KSCHL" , "SPRAS" , "PARNR" , "PARVW" , "ERDAT" , "ERUHR" , "ADRNR" , "NACHA" , "ANZAL" , "VSZTP" , "VSDAT" , "VSURA" , "VSURB" , "MANUE" , "DATVR" , "UHRVR" , "DATRE" , "USNAM" , "VSTAT" , "AKTIV"                     |SAPC11 |ABAP:C11       |SD_BATCH    |SAPFV45P:7989                         |C11/saphana8_C11_33|0213_QDU_ZC_UPD_SO_RR_EMEAMEEAG1|      |                      |
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
( SELECT
  ...
  ( SELECT                                                      /* Modification section */
      ...
      'NONE' AGGREGATE_BY,                /* TIME, SITE_ID, HOST, PORT, THREAD_ID, THREAD_TYPE, THREAD_METHOD, THREAD_STATE, THREAD_DETAIL, HASH, ROOT, STATEMENT_ID, STAT_EXEC_ID, DB_USER, APP_NAME, 
      ...
      'TIME' ORDER_BY               /* COUNT, TIME, CONN_ID, DURATION */
    FROM
      DUMMY
  )
),
...
GROUP BY
  ...
  ORDER_BY
ORDER BY
  MAP(ORDER_BY, 'COUNT', SUM(NUM_SAMPLES), 'DURATION', SUM(DURATION_MS)) DESC,
