  ...
  ( SELECT
    ...
    ( SELECT
        CASE
          ...
          WHEN FILE_NAME LIKE '%component_history%'                                              THEN 'Component History'
          WHEN FILE_NAME LIKE '%cpu%.dot'                                                        THEN 'Kernel Profiler'
          WHEN FILE_NAME LIKE '%CPU%.dot'                                                        THEN 'Kernel Profiler'
          ...
          WHEN FILE_NAME LIKE '%.plv'                                                            THEN 'PlanViz'
          WHEN FILE_NAME LIKE '%.profiler.trc%'                                                  THEN 'Function Profiler'
          ...
          WHEN FILE_NAME LIKE '%wait%.dot'                                                       THEN 'Kernel Profiler'
          WHEN FILE_NAME LIKE '%WAIT%.dot'                                                       THEN 'Kernel Profiler'
